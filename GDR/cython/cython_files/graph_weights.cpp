...
/* BEGIN: Cython Metadata
{
    ...
    "module_name": "graph_weights_build"
}
END: Cython Metadata */
...
#define __PYX_HAVE__graph_weights_build
#define __PYX_HAVE_API__graph_weights_build
/* Early includes */
#include <string.h>
#include <stdio.h>
...
#include "../cuda_wrappers/gpu_graph_weights.cpp"
#include "pythread.h"
#include <stdlib.h>
#include "pystate.h"
#ifdef _OPENMP
...
/* Module declarations from 'graph_weights_build' */
...
static void __pyx_f_19graph_weights_build__graph_weights(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int, int, float, int); /*proto*/
...
#define __Pyx_MODULE_NAME "graph_weights_build"
extern int __pyx_module_is_main_graph_weights_build;
int __pyx_module_is_main_graph_weights_build = 0;

/* Implementation of 'graph_weights_build' */
...
static const char __pyx_k_knn_dists[] = "knn_dists";
...
static const char __pyx_k_knn_indices[] = "knn_indices";
static const char __pyx_k_n_neighbors[] = "n_neighbors";
static const char __pyx_k_pyx_checksum[] = "__pyx_checksum";
static const char __pyx_k_return_dists[] = "return_dists";
static const char __pyx_k_stringsource[] = "stringsource";
static const char __pyx_k_graph_weights[] = "graph_weights";
static const char __pyx_k_pyx_getbuffer[] = "__pyx_getbuffer";
static const char __pyx_k_reduce_cython[] = "__reduce_cython__";
static const char __pyx_k_View_MemoryView[] = "View.MemoryView";
static const char __pyx_k_allocate_buffer[] = "allocate_buffer";
static const char __pyx_k_dtype_is_object[] = "dtype_is_object";
static const char __pyx_k_pseudo_distance[] = "pseudo_distance";
...
static const char __pyx_k_graph_weights_build[] = "graph_weights_build";
...
static const char __pyx_k_cython_cython_files_graph_weight[] = "cython/cython_files/graph_weights.pyx";
...
static PyObject *__pyx_kp_s_cython_cython_files_graph_weight;
...
static PyObject *__pyx_n_s_graph_weights;
static PyObject *__pyx_n_s_graph_weights_build;
static PyObject *__pyx_n_s_id;
static PyObject *__pyx_n_s_import;
static PyObject *__pyx_n_s_itemsize;
static PyObject *__pyx_kp_s_itemsize_0_for_cython_array;
static PyObject *__pyx_n_s_knn_dists;
static PyObject *__pyx_n_s_knn_indices;
...
static PyObject *__pyx_n_s_pseudo_distance;
...
static PyObject *__pyx_n_s_return_dists;
...
static PyObject *__pyx_pf_19graph_weights_build_graph_weights(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_sigmas, __Pyx_memviewslice __pyx_v_rhos, __Pyx_memviewslice __pyx_v_rows, __Pyx_memviewslice __pyx_v_cols, __Pyx_memviewslice __pyx_v_values, __Pyx_memviewslice __pyx_v_dists, __Pyx_memviewslice __pyx_v_knn_indices, __Pyx_memviewslice __pyx_v_knn_dists, int __pyx_v_n_neighbors, int __pyx_v_return_dists, float __pyx_v_local_connectivity, int __pyx_v_pseudo_distance); /* proto */
...
/* "cython/cython_files/graph_weights.pyx":23
 *     )
 * 
...
static void __pyx_f_19graph_weights_build__graph_weights(__Pyx_memviewslice __pyx_v_sigmas, __Pyx_memviewslice __pyx_v_rhos, __Pyx_memviewslice __pyx_v_rows, __Pyx_memviewslice __pyx_v_cols, __Pyx_memviewslice __pyx_v_values, __Pyx_memviewslice __pyx_v_dists, __Pyx_memviewslice __pyx_v_knn_indices, __Pyx_memviewslice __pyx_v_knn_dists, int __pyx_v_n_points, int __pyx_v_n_neighbors, int __pyx_v_return_dists, float __pyx_v_local_connectivity, int __pyx_v_pseudo_distance) {
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("_graph_weights", 0);

  /* "cython/cython_files/graph_weights.pyx":39
 * ):
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_1 < 0) {
    __pyx_t_1 += __pyx_v_rows.shape[0];
    if (unlikely(__pyx_t_1 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_1 >= __pyx_v_rows.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(0, 39, __pyx_L1_error)
  }

  /* "cython/cython_files/graph_weights.pyx":40
 *     compute_neighbor_graph(
 *         &rows[0], #return val
 *         &cols[0], #return val             # <<<<<<<<<<<<<<
 *         &values[0], #return val
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_3 < 0) {
    __pyx_t_3 += __pyx_v_cols.shape[0];
    if (unlikely(__pyx_t_3 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_3 >= __pyx_v_cols.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(0, 40, __pyx_L1_error)
  }

  /* "cython/cython_files/graph_weights.pyx":41
 *         &rows[0], #return val
 *         &cols[0], #return val
 *         &values[0], #return val             # <<<<<<<<<<<<<<
 *         &dists[0], #return val
 ...
 */
  ...
  } else if (unlikely(__pyx_t_4 >= __pyx_v_values.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(0, 41, __pyx_L1_error)
  }

  /* "cython/cython_files/graph_weights.pyx":42
 *         &cols[0], #return val
 *         &values[0], #return val
 *         &dists[0], #return val             # <<<<<<<<<<<<<<
 *         &sigmas[0], #return val
 ...
 */
  ...
  } else if (unlikely(__pyx_t_5 >= __pyx_v_dists.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(0, 42, __pyx_L1_error)
  }

  /* "cython/cython_files/graph_weights.pyx":43
 *         &values[0], #return val
 *         &dists[0], #return val
 *         &sigmas[0], #return val             # <<<<<<<<<<<<<<
 *         &rhos[0], #return val
 ...
 */
  ...
  /* "cython/cython_files/graph_weights.pyx":44
 *         &dists[0], #return val
 *         &sigmas[0], #return val
 *         &rhos[0], #return val             # <<<<<<<<<<<<<<
 *         &knn_indices[0,0],
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_7 < 0) {
    __pyx_t_7 += __pyx_v_rhos.shape[0];
    if (unlikely(__pyx_t_7 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_7 >= __pyx_v_rhos.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(0, 44, __pyx_L1_error)
  }

  /* "cython/cython_files/graph_weights.pyx":45
 *         &sigmas[0], #return val
 *         &rhos[0], #return val
 *         &knn_indices[0,0],             # <<<<<<<<<<<<<<
 *         &knn_dists[0,0],
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_8 < 0) {
    __pyx_t_8 += __pyx_v_knn_indices.shape[0];
    if (unlikely(__pyx_t_8 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_8 >= __pyx_v_knn_indices.shape[0])) __pyx_t_2 = 0;
  if (__pyx_t_9 < 0) {
    __pyx_t_9 += __pyx_v_knn_indices.shape[1];
    if (unlikely(__pyx_t_9 < 0)) __pyx_t_2 = 1;
  } else if (unlikely(__pyx_t_9 >= __pyx_v_knn_indices.shape[1])) __pyx_t_2 = 1;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(0, 45, __pyx_L1_error)
  }

  /* "cython/cython_files/graph_weights.pyx":46
 *         &rhos[0], #return val
 *         &knn_indices[0,0],
 *         &knn_dists[0,0],             # <<<<<<<<<<<<<<
 *         n_points,
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_10 < 0) {
    __pyx_t_10 += __pyx_v_knn_dists.shape[0];
    if (unlikely(__pyx_t_10 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_10 >= __pyx_v_knn_dists.shape[0])) __pyx_t_2 = 0;
  if (__pyx_t_11 < 0) {
    __pyx_t_11 += __pyx_v_knn_dists.shape[1];
    if (unlikely(__pyx_t_11 < 0)) __pyx_t_2 = 1;
  } else if (unlikely(__pyx_t_11 >= __pyx_v_knn_dists.shape[1])) __pyx_t_2 = 1;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(0, 46, __pyx_L1_error)
  }

  /* "cython/cython_files/graph_weights.pyx":38
 *     int pseudo_distance
 * ):
 *     compute_neighbor_graph(             # <<<<<<<<<<<<<<
 *         &rows[0], #return val
 *         &cols[0], #return val
 */
  compute_neighbor_graph((&(*((int *) ( /* dim=0 */ (__pyx_v_rows.data + __pyx_t_1 * __pyx_v_rows.strides[0]) )))), (&(*((int *) ( /* dim=0 */ (__pyx_v_cols.data + __pyx_t_3 * __pyx_v_cols.strides[0]) )))), (&(*((float *) ( /* dim=0 */ (__pyx_v_values.data + __pyx_t_4 * __pyx_v_values.strides[0]) )))), (&(*((float *) ( /* dim=0 */ (__pyx_v_dists.data + __pyx_t_5 * __pyx_v_dists.strides[0]) )))), (&(*((float *) ( /* dim=0 */ (__pyx_v_sigmas.data + __pyx_t_6 * __pyx_v_sigmas.strides[0]) )))), (&(*((float *) ( /* dim=0 */ (__pyx_v_rhos.data + __pyx_t_7 * __pyx_v_rhos.strides[0]) )))), (&(*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_knn_indices.data + __pyx_t_8 * __pyx_v_knn_indices.strides[0]) ) + __pyx_t_9 * __pyx_v_knn_indices.strides[1]) )))), (&(*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_knn_dists.data + __pyx_t_10 * __pyx_v_knn_dists.strides[0]) ) + __pyx_t_11 * __pyx_v_knn_dists.strides[1]) )))), __pyx_v_n_points, __pyx_v_n_neighbors, __pyx_v_local_connectivity, __pyx_v_return_dists, __pyx_v_pseudo_distance);
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("graph_weights_build._graph_weights", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}

/* "cython/cython_files/graph_weights.pyx":54
 *     )
 * 
 * def graph_weights(             # <<<<<<<<<<<<<<
 *         float[:] sigmas,
...
/* Python wrapper */
static PyObject *__pyx_pw_19graph_weights_build_1graph_weights(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_19graph_weights_build_1graph_weights = {"graph_weights", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_19graph_weights_build_1graph_weights, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_19graph_weights_build_1graph_weights(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_memviewslice __pyx_v_knn_indices = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_knn_dists = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_n_neighbors;
  int __pyx_v_return_dists;
  float __pyx_v_local_connectivity;
  int __pyx_v_pseudo_distance;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("graph_weights (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_sigmas,&__pyx_n_s_rhos,&__pyx_n_s_rows,&__pyx_n_s_cols,&__pyx_n_s_values,&__pyx_n_s_dists,&__pyx_n_s_knn_indices,&__pyx_n_s_knn_dists,&__pyx_n_s_n_neighbors,&__pyx_n_s_return_dists,&__pyx_n_s_local_connectivity,&__pyx_n_s_pseudo_distance,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_sigmas)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_rhos)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("graph_weights", 1, 12, 12, 1); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_rows)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("graph_weights", 1, 12, 12, 2); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_cols)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("graph_weights", 1, 12, 12, 3); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_values)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("graph_weights", 1, 12, 12, 4); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_dists)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("graph_weights", 1, 12, 12, 5); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_knn_indices)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("graph_weights", 1, 12, 12, 6); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_knn_dists)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("graph_weights", 1, 12, 12, 7); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_neighbors)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("graph_weights", 1, 12, 12, 8); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_return_dists)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("graph_weights", 1, 12, 12, 9); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_local_connectivity)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("graph_weights", 1, 12, 12, 10); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 11:
        if (likely((values[11] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pseudo_distance)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("graph_weights", 1, 12, 12, 11); __PYX_ERR(0, 54, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "graph_weights") < 0)) __PYX_ERR(0, 54, __pyx_L3_error)
      }
    ...
    __pyx_v_sigmas = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_sigmas.memview)) __PYX_ERR(0, 55, __pyx_L3_error)
    __pyx_v_rhos = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_rhos.memview)) __PYX_ERR(0, 56, __pyx_L3_error)
    __pyx_v_rows = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_rows.memview)) __PYX_ERR(0, 57, __pyx_L3_error)
    __pyx_v_cols = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_cols.memview)) __PYX_ERR(0, 58, __pyx_L3_error)
    __pyx_v_values = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_values.memview)) __PYX_ERR(0, 59, __pyx_L3_error)
    __pyx_v_dists = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_dists.memview)) __PYX_ERR(0, 60, __pyx_L3_error)
    __pyx_v_knn_indices = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[6], PyBUF_WRITABLE); if (unlikely(!__pyx_v_knn_indices.memview)) __PYX_ERR(0, 61, __pyx_L3_error)
    __pyx_v_knn_dists = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(values[7], PyBUF_WRITABLE); if (unlikely(!__pyx_v_knn_dists.memview)) __PYX_ERR(0, 62, __pyx_L3_error)
    __pyx_v_n_neighbors = __Pyx_PyInt_As_int(values[8]); if (unlikely((__pyx_v_n_neighbors == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 63, __pyx_L3_error)
    __pyx_v_return_dists = __Pyx_PyInt_As_int(values[9]); if (unlikely((__pyx_v_return_dists == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 64, __pyx_L3_error)
    __pyx_v_local_connectivity = __pyx_PyFloat_AsFloat(values[10]); if (unlikely((__pyx_v_local_connectivity == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 65, __pyx_L3_error)
    __pyx_v_pseudo_distance = __Pyx_PyInt_As_int(values[11]); if (unlikely((__pyx_v_pseudo_distance == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 66, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("graph_weights", 1, 12, 12, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 54, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("graph_weights_build.graph_weights", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_19graph_weights_build_graph_weights(__pyx_self, __pyx_v_sigmas, __pyx_v_rhos, __pyx_v_rows, __pyx_v_cols, __pyx_v_values, __pyx_v_dists, __pyx_v_knn_indices, __pyx_v_knn_dists, __pyx_v_n_neighbors, __pyx_v_return_dists, __pyx_v_local_connectivity, __pyx_v_pseudo_distance);
...
static PyObject *__pyx_pf_19graph_weights_build_graph_weights(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_sigmas, __Pyx_memviewslice __pyx_v_rhos, __Pyx_memviewslice __pyx_v_rows, __Pyx_memviewslice __pyx_v_cols, __Pyx_memviewslice __pyx_v_values, __Pyx_memviewslice __pyx_v_dists, __Pyx_memviewslice __pyx_v_knn_indices, __Pyx_memviewslice __pyx_v_knn_dists, int __pyx_v_n_neighbors, int __pyx_v_return_dists, float __pyx_v_local_connectivity, int __pyx_v_pseudo_distance) {
  int __pyx_v_n_points;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("graph_weights", 0);

  /* "cython/cython_files/graph_weights.pyx":68
 *         int pseudo_distance
 * ):
 ...
 *         sigmas,
 */
  __pyx_v_n_points = (__pyx_v_knn_dists.shape[0]);

  /* "cython/cython_files/graph_weights.pyx":69
 * ):
 *     cdef int n_points = knn_dists.shape[0]
 *     _graph_weights(             # <<<<<<<<<<<<<<
 *         sigmas,
 *         rhos,
 */
  __pyx_f_19graph_weights_build__graph_weights(__pyx_v_sigmas, __pyx_v_rhos, __pyx_v_rows, __pyx_v_cols, __pyx_v_values, __pyx_v_dists, __pyx_v_knn_indices, __pyx_v_knn_dists, __pyx_v_n_points, __pyx_v_n_neighbors, __pyx_v_return_dists, __pyx_v_local_connectivity, __pyx_v_pseudo_distance);
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_knn_indices, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_knn_dists, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "graph_weights_build.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "graph_weights_build.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "graph_weights_build.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "graph_weights_build._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_graph_weights_build(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_graph_weights_build},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_cython_cython_files_graph_weight, __pyx_k_cython_cython_files_graph_weight, sizeof(__pyx_k_cython_cython_files_graph_weight), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_graph_weights, __pyx_k_graph_weights, sizeof(__pyx_k_graph_weights), 0, 0, 1, 1},
  {&__pyx_n_s_graph_weights_build, __pyx_k_graph_weights_build, sizeof(__pyx_k_graph_weights_build), 0, 0, 1, 1},
  {&__pyx_n_s_id, __pyx_k_id, sizeof(__pyx_k_id), 0, 0, 1, 1},
  {&__pyx_n_s_import, __pyx_k_import, sizeof(__pyx_k_import), 0, 0, 1, 1},
  {&__pyx_n_s_itemsize, __pyx_k_itemsize, sizeof(__pyx_k_itemsize), 0, 0, 1, 1},
  {&__pyx_kp_s_itemsize_0_for_cython_array, __pyx_k_itemsize_0_for_cython_array, sizeof(__pyx_k_itemsize_0_for_cython_array), 0, 0, 1, 0},
  {&__pyx_n_s_knn_dists, __pyx_k_knn_dists, sizeof(__pyx_k_knn_dists), 0, 0, 1, 1},
  {&__pyx_n_s_knn_indices, __pyx_k_knn_indices, sizeof(__pyx_k_knn_indices), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_pseudo_distance, __pyx_k_pseudo_distance, sizeof(__pyx_k_pseudo_distance), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_return_dists, __pyx_k_return_dists, sizeof(__pyx_k_return_dists), 0, 0, 1, 1},
 ...
 *         float[:] rhos,
 */
  __pyx_tuple__21 = PyTuple_Pack(13, __pyx_n_s_sigmas, __pyx_n_s_rhos, __pyx_n_s_rows, __pyx_n_s_cols, __pyx_n_s_values, __pyx_n_s_dists, __pyx_n_s_knn_indices, __pyx_n_s_knn_dists, __pyx_n_s_n_neighbors, __pyx_n_s_return_dists, __pyx_n_s_local_connectivity, __pyx_n_s_pseudo_distance, __pyx_n_s_n_points); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__21);
  __Pyx_GIVEREF(__pyx_tuple__21);
  __pyx_codeobj__22 = (PyObject*)__Pyx_PyCode_New(12, 0, 13, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cython_cython_files_graph_weight, __pyx_n_s_graph_weights, 54, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__22)) __PYX_ERR(0, 54, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initgraph_weights_build(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initgraph_weights_build(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_graph_weights_build(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_graph_weights_build(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_graph_weights_build(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  int __pyx_t_1;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'graph_weights_build' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_graph_weights_build(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("graph_weights_build", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_graph_weights_build) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "graph_weights_build")) {
      if (unlikely(PyDict_SetItemString(modules, "graph_weights_build", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "cython/cython_files/graph_weights.pyx":4
 * cimport cython
 * 
 * np.import_array()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = __pyx_f_5numpy_import_array(); if (unlikely(__pyx_t_1 == ((int)-1))) __PYX_ERR(0, 4, __pyx_L1_error)
 ...
 *         float[:] rhos,
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_19graph_weights_build_1graph_weights, NULL, __pyx_n_s_graph_weights_build); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_graph_weights, __pyx_t_2) < 0) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "cython/cython_files/graph_weights.pyx":1
 * cimport numpy as np             # <<<<<<<<<<<<<<
 * cimport cython
 * 
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init graph_weights_build", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init graph_weights_build");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
