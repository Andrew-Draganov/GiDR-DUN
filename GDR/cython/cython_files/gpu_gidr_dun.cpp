...
/* "cython/cython_files/gpu_gidr_dun.pyx":37
 *     )
 * 
...
/* "cython/cython_files/gpu_gidr_dun.pyx":38
 * 
 * ctypedef np.float32_t DTYPE_FLOAT
 * ctypedef np.int32_t DTYPE_INT             # <<<<<<<<<<<<<<
 * 
...
static const char __pyx_k_cython_cython_files_gpu_gidr_dun[] = "cython/cython_files/gpu_gidr_dun.pyx";
...
static PyObject *__pyx_kp_s_cython_cython_files_gpu_gidr_dun;
...
/* "cython/cython_files/gpu_gidr_dun.pyx":40
 * ctypedef np.int32_t DTYPE_INT
 * 
 * cdef uniform_umap_gpu(             # <<<<<<<<<<<<<<
 *     int normalized,
...
static PyObject *__pyx_f_12optimize_gpu_uniform_umap_gpu(int __pyx_v_normalized, int __pyx_v_sym_attraction, int __pyx_v_frob, int __pyx_v_amplify_grads, PyArrayObject *__pyx_v_head_embedding, PyArrayObject *__pyx_v_tail_embedding, PyArrayObject *__pyx_v_head, PyArrayObject *__pyx_v_tail, PyArrayObject *__pyx_v_weights, PyArrayObject *__pyx_v_neighbor_counts, float __pyx_v_a, float __pyx_v_b, int __pyx_v_dim, float __pyx_v_initial_lr, int __pyx_v_n_epochs, int __pyx_v_n_vertices, int __pyx_v_negative_sample_rate, CYTHON_UNUSED int __pyx_v_verbose) {
  ...
  /* "cython/cython_files/gpu_gidr_dun.pyx":65
 ...
 */
  ...
  /* "cython/cython_files/gpu_gidr_dun.pyx":66
 * 
 *     all_updates = py_np.zeros([n_vertices, dim], dtype=py_np.float32, order='c')
 *     gains = py_np.ones([n_vertices, dim], dtype=py_np.float32, order='c')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython/cython_files/gpu_gidr_dun.pyx":68
 *     gains = py_np.ones([n_vertices, dim], dtype=py_np.float32, order='c')
 * 
 *     cdef int n_edges = int(weights.shape[0])             # <<<<<<<<<<<<<<
 *     gpu_umap_wrap(
 ...
 */
  ...
  /* "cython/cython_files/gpu_gidr_dun.pyx":74
 *         frob,
 *         amplify_grads,
 ...
 */
  ...
  /* "cython/cython_files/gpu_gidr_dun.pyx":75
 *         amplify_grads,
 *         &head_embedding[0, 0], # Move from numpy to c pointer arrays
 *         &tail_embedding[0, 0],             # <<<<<<<<<<<<<<
 *         &head[0],
 ...
 */
  ...
  /* "cython/cython_files/gpu_gidr_dun.pyx":76
 *         &head_embedding[0, 0], # Move from numpy to c pointer arrays
 *         &tail_embedding[0, 0],
 *         &head[0],             # <<<<<<<<<<<<<<
 *         &tail[0],
 ...
 */
  ...
  /* "cython/cython_files/gpu_gidr_dun.pyx":77
 *         &tail_embedding[0, 0],
 *         &head[0],
 *         &tail[0],             # <<<<<<<<<<<<<<
 *         &weights[0],
 ...
 */
  ...
  /* "cython/cython_files/gpu_gidr_dun.pyx":78
 *         &head[0],
 *         &tail[0],
 *         &weights[0],             # <<<<<<<<<<<<<<
 *         &neighbor_counts[0],
 ...
 */
  ...
  /* "cython/cython_files/gpu_gidr_dun.pyx":79
 *         &tail[0],
 *         &weights[0],
 *         &neighbor_counts[0],             # <<<<<<<<<<<<<<
 *         &all_updates[0, 0],
 ...
 */
  ...
  /* "cython/cython_files/gpu_gidr_dun.pyx":80
 *         &weights[0],
 *         &neighbor_counts[0],
 *         &all_updates[0, 0],             # <<<<<<<<<<<<<<
 *         &gains[0, 0],
 ...
 */
  ...
  /* "cython/cython_files/gpu_gidr_dun.pyx":81
 *         &neighbor_counts[0],
 *         &all_updates[0, 0],
 *         &gains[0, 0],             # <<<<<<<<<<<<<<
 *         a,
 ...
 */
  ...
  /* "cython/cython_files/gpu_gidr_dun.pyx":69
 * 
 *     cdef int n_edges = int(weights.shape[0])
 *     gpu_umap_wrap(             # <<<<<<<<<<<<<<
 *         normalized,
...
/* "cython/cython_files/gpu_gidr_dun.pyx":96
...
static PyObject *__pyx_pw_12optimize_gpu_1gpu_opt_wrapper(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_GOTREF(__pyx_v_kwargs);
  {
    ...
    if (values[16]) {
      ...
      /* "cython/cython_files/gpu_gidr_dun.pyx":113
 *     float initial_lr,
...
static PyObject *__pyx_pf_12optimize_gpu_gpu_opt_wrapper(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_normalized, int __pyx_v_sym_attraction, int __pyx_v_frob, int __pyx_v_amplify_grads, PyArrayObject *__pyx_v_head, PyArrayObject *__pyx_v_tail, PyArrayObject *__pyx_v_head_embedding, PyArrayObject *__pyx_v_tail_embedding, PyArrayObject *__pyx_v_weights, PyArrayObject *__pyx_v_neighbor_counts, int __pyx_v_n_epochs, int __pyx_v_n_vertices, float __pyx_v_a, float __pyx_v_b, float __pyx_v_initial_lr, int __pyx_v_negative_sample_rate, int __pyx_v_verbose, CYTHON_UNUSED PyObject *__pyx_v_kwargs) {
  ...
  /* "cython/cython_files/gpu_gidr_dun.pyx":118
 *     cdef:
 *         int i_epoch, n_edges
 ...
 */
  ...
  /* "cython/cython_files/gpu_gidr_dun.pyx":121
 * 
 *     # Perform weight scaling on high-dimensional relationships
 ...
 */
  ...
  /* "cython/cython_files/gpu_gidr_dun.pyx":122
 *     # Perform weight scaling on high-dimensional relationships
 *     cdef float weight_sum = 0.0
 *     if normalized:             # <<<<<<<<<<<<<<
 *         for i in range(weights.shape[0]):
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "cython/cython_files/gpu_gidr_dun.pyx":123
 *     cdef float weight_sum = 0.0
 *     if normalized:
 *         for i in range(weights.shape[0]):             # <<<<<<<<<<<<<<
 *             weight_sum += weights[i]
 ...
 */
    ...
    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      ...
      /* "cython/cython_files/gpu_gidr_dun.pyx":124
 *     if normalized:
 *         for i in range(weights.shape[0]):
 *             weight_sum += weights[i]             # <<<<<<<<<<<<<<
 *         for i in range(weights.shape[0]):
 ...
 */
    ...
    /* "cython/cython_files/gpu_gidr_dun.pyx":125
 *         for i in range(weights.shape[0]):
 *             weight_sum += weights[i]
 *         for i in range(weights.shape[0]):             # <<<<<<<<<<<<<<
 *             weights[i] /= weight_sum
 ...
 */
    ...
    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      ...
      /* "cython/cython_files/gpu_gidr_dun.pyx":126
 *             weight_sum += weights[i]
 *         for i in range(weights.shape[0]):
 *             weights[i] /= weight_sum             # <<<<<<<<<<<<<<
 *         initial_lr *= 200
 ...
 */
    ...
    /* "cython/cython_files/gpu_gidr_dun.pyx":127
 *         for i in range(weights.shape[0]):
 *             weights[i] /= weight_sum
 *         initial_lr *= 200             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cython/cython_files/gpu_gidr_dun.pyx":129
 *         initial_lr *= 200
 * 
 *     uniform_umap_gpu(             # <<<<<<<<<<<<<<
 *         normalized,
 ...
 */
  ...
  /* "cython/cython_files/gpu_gidr_dun.pyx":150
 *     )
 * 
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_cython_cython_files_gpu_gidr_dun, __pyx_k_cython_cython_files_gpu_gidr_dun, sizeof(__pyx_k_cython_cython_files_gpu_gidr_dun), 0, 0, 1, 0},
 ...
 */
  ...
  __pyx_codeobj__4 = (PyObject*)__Pyx_PyCode_New(17, 0, 23, 0, CO_OPTIMIZED|CO_NEWLOCALS|CO_VARKEYWORDS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__3, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cython_cython_files_gpu_gidr_dun, __pyx_n_s_gpu_opt_wrapper, 96, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__4)) __PYX_ERR(0, 96, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  /* "cython/cython_files/gpu_gidr_dun.pyx":1
 ...
 */
  ...
  /* "cython/cython_files/gpu_gidr_dun.pyx":11
 * 
