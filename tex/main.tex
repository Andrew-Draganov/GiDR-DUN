...
\begin{figure*}[h]
    \begin{tabular}{cc}
        \includegraphics[width=.24\linewidth]{outputs/grad_images/tsne_linear.pdf}\par
        \includegraphics[width=.24\linewidth]{outputs/grad_images/umap_linear.pdf}\par
        \includegraphics[width=.24\linewidth]{outputs/grad_images/tsne_exp.pdf}\par
        \includegraphics[width=.24\linewidth]{outputs/grad_images/umap_exp.pdf}\\
        \includegraphics[width=.24\linewidth]{outputs/grad_images/tsne_linear_frob.pdf}\par
        \includegraphics[width=.24\linewidth]{outputs/grad_images/umap_linear_frob.pdf}\par
        \includegraphics[width=.24\linewidth]{outputs/grad_images/tsne_exp_frob.pdf}\par
        \includegraphics[width=.24\linewidth]{outputs/grad_images/umap_exp_frob.pdf}
    \end{tabular}
