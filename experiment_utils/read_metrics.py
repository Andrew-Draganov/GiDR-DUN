...
def make_gpu_bar_plots(outputs):
    all_opt_methods = {
        'rapids_tsne': {},
        'rapids_umap': {},
        'recreate_tsne_gpu': {},
...
def make_line_plots(outputs, x_axis_title=''):
    all_opt_methods = {
        'rapids_tsne_barnes_hut': {},
        'rapids_tsne_fft': {},
        'rapids_umap': {},
        'recreate_tsne_gpu': {},
        'recreate_umap_gpu': {}
    ...
    method_labels = {
        'rapids_tsne_barnes_hut': 'Rapids TSNE BH',
        'rapids_tsne_fft': 'Rapids TSNE FFT',
        'rapids_tsne': 'Rapids TSNE',
        'rapids_umap': 'Rapids UMAP',
        'recreate_umap_gpu': 'GDR-umap',
        'recreate_tsne_gpu': 'GDR-tsne'
...
if __name__ == '__main__':
    ...
    make_line_plots(dim_times, 'X dimensionality')
    ...
    #     relevant_key='total_time'
    # )
    # make_line_plots(data_size_times, 'Number of points')
